...
```{r}
  daily$clickInt<-ifelse(daily$click==1 & daily$intervention_content=="yes",1,
                        ifelse(daily$intervention_content=="no"|is.na(daily$intervention_content),0,NA))
  daily$engageInt<-ifelse(daily$engage==1 & daily$intervention_content=="yes",1,
                        ifelse(daily$intervention_content=="no"|is.na(daily$intervention_content),0,NA))
```
