...
# minute$nonWearMean<-ifelse(is.na(minute$nonWearMean),minute$nonWearFlag,minute$nonWearMean) # first 10 observations will be non-wear time for all participants
```
...
```{r}
  length(daily[daily$TotalTimeInBed==0,]$Id) # 565 participant-days with 0 time in bed
