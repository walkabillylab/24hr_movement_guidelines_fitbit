...
```{r}
  ...
  assess$test<-assess$TotalTimeAsleep+assess$TotalTimeAwake
```
...
names(data)
  ...
  length(unique(assess[assess$sum_minutes!=1440,]$Id))
  length(unique(assess$Id)) # almost every participant had at least one day with < or > 1440 minutes
```
